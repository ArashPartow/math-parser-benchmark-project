...
extern const MIDL_SERVER_INFO IMTParserPlugin_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IMTParserPlugin_ProxyInfo;
...
/* 304 */	NdrFcShort( 0x24 ),	/* Type Offset=36 */
...
/* Object interface: IMTParserPlugin, ver. 0.0,
   GUID={0x91893C09,0xF41E,0x4389,{0x91,0x85,0x42,0xB2,0xE0,0xD5,0xA4,0x9E}} */

#pragma code_seg(".orpc")
static const unsigned short IMTParserPlugin_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IMTParserPlugin_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IMTParserPlugin_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IMTParserPlugin_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(15) _IMTParserPluginProxyVtbl = 
{
    &IMTParserPlugin_ProxyInfo,
    &IID_IMTParserPlugin,
    ...
    (void *) (INT_PTR) -1 /* IMTParserPlugin::getNbConsts */ ,
    (void *) (INT_PTR) -1 /* IMTParserPlugin::getConst */ ,
    (void *) (INT_PTR) -1 /* IMTParserPlugin::getNbFuncs */ ,
    (void *) (INT_PTR) -1 /* IMTParserPlugin::newFunc */ ,
    (void *) (INT_PTR) -1 /* IMTParserPlugin::getNbOps */ ,
    (void *) (INT_PTR) -1 /* IMTParserPlugin::newOp */ ,
    (void *) (INT_PTR) -1 /* IMTParserPlugin::getMTParserVersion */ ,
    (void *) (INT_PTR) -1 /* IMTParserPlugin::getInfoFile */
};


static const PRPC_STUB_FUNCTION IMTParserPlugin_table[] =
{
...
CInterfaceStubVtbl _IMTParserPluginStubVtbl =
{
    &IID_IMTParserPlugin,
    &IMTParserPlugin_ServerInfo,
    15,
    &IMTParserPlugin_table[-3],
...
const CInterfaceProxyVtbl * __MTParserPlugin_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IMTParserPluginProxyVtbl,
    0
};

const CInterfaceStubVtbl * __MTParserPlugin_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IMTParserPluginStubVtbl,
    0
};

PCInterfaceName const __MTParserPlugin_InterfaceNamesList[] = 
{
    "IMTParserPlugin",
    0
};

const IID *  __MTParserPlugin_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define __MTParserPlugin_CHECK_IID(n)	IID_GENERIC_CHECK_IID( __MTParserPlugin, pIID, n)

int __stdcall __MTParserPlugin_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!__MTParserPlugin_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo _MTParserPlugin_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & __MTParserPlugin_ProxyVtblList,
    (PCInterfaceStubVtblList *) & __MTParserPlugin_StubVtblList,
    (const PCInterfaceName * ) & __MTParserPlugin_InterfaceNamesList,
    (const IID ** ) & __MTParserPlugin_BaseIIDList,
    & __MTParserPlugin_IID_Lookup, 
    1,
    2,
