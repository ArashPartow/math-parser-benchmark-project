...
class ParserBase 
{
  ...
  protected:
    ...
    typedef const TValue& (ParserBase::*ParseFunction)() const;  
  ...
  public:
    ...
    */
    MUP_INLINE const TValue&  Eval() const
    {
...
protected:
 ...
 private:
    ...
    //---------------------------------------------------------------------------------------------
    const TValue& ParseString() const
    {
      CreateRPN();
...
*/
    ...
    //---------------------------------------------------------------------------------------------
    // Parsing engines
    const TValue& ParseCmdCode() const
    {
  ...
  #define SXO_FUN(TOK) \
    ...
    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_C1() const
    {    
      return *m_pStack = m_pRPN->Val.fixed;
    }

    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_C2() const
    {    
      return *m_pStack = *m_pRPN->Val.ptr * m_pRPN->Val.mul;
    }

    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_V() const
    {    
      return *m_pStack = *m_pRPN->Val.ptr * m_pRPN->Val.mul + m_pRPN->Val.fixed;
    }

    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_VF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_FUN(&m_pRPN[1])
    ...
    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_VFF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_FUN(&m_pRPN[1])
    ...
    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_VVF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_VAL(&m_pRPN[1])
    ...
    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_VFFF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_FUN(&m_pRPN[1])
    ...
    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_VFVF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_FUN(&m_pRPN[1])
    ...
    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_VVFF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_VAL(&m_pRPN[1])
    ...
    //---------------------------------------------------------------------------------------------
    const TValue& ParseCmdCode_VVVF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_VAL(&m_pRPN[1])
