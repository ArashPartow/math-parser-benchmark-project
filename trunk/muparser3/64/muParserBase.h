...
class ParserBase 
{
  ...
  protected:
    ...
    {
      int idx;
      const token_type *rpn;
      TValue *stack;
    };
    typedef void (*eval_step_fun)(reginfo &info);
...
protected:
 ...
 private:
    ...
    void CreateRPN() const
    {
      ...
      m_info.rpn   = m_vRPN.GetBase();
      m_info.stack = &m_vStackBuffer[0];
      m_info.idx   = 0;
    ...
    TValue ParseString() const
    {
      ...
      else
      {
        ...
        case ecVF:   m_pParseFormula = &ParserBase::ParseCmdCode_VF;  break;

        case ecVFF:  m_pParseFormula = &ParserBase::ParseCmdCode_VFF; break;
        case ecVVF:  m_pParseFormula = &ParserBase::ParseCmdCode_VVF; break;

        case ecVFFF: m_pParseFormula = &ParserBase::ParseCmdCode_VFFF; break;
        case ecVFVF: m_pParseFormula = &ParserBase::ParseCmdCode_VFVF; break;
        case ecVVFF: m_pParseFormula = &ParserBase::ParseCmdCode_VVFF; break;
        case ecVVVF: m_pParseFormula = &ParserBase::ParseCmdCode_VVVF; break;
/*
        case ecVF:     m_pParseFormula = &ParserBase::ParseCmdCode1<ValFun<0>>; break;

        case ecVFF:    m_pParseFormula = &ParserBase::ParseCmdCode2<ValFun<0>, Fun<2>>; break;
        case ecVVF:    m_pParseFormula = &ParserBase::ParseCmdCode2<ValVal<0>, Fun<2>>;  break;

        case ecVFFF:   m_pParseFormula = &ParserBase::ParseCmdCode2<ValFun<0>, FunFun<2>>; break;
        case ecVFVF:   m_pParseFormula = &ParserBase::ParseCmdCode2<ValFun<0>, ValFun<2>>; break;
        case ecVVFF:   m_pParseFormula = &ParserBase::ParseCmdCode2<ValVal<0>, FunFun<2>>; break;
        case ecVVVF:   m_pParseFormula = &ParserBase::ParseCmdCode2<ValVal<0>, ValFun<2>>; break;

        case ecVFFFF:  m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, FunFun<2>, Fun<4>>; break;
        case ecVFFVF:  m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, FunVal<2>, Fun<4>>; break;
        case ecVFVFF:  m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, ValFun<2>, Fun<4>>; break;
        case ecVFVVF:  m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, ValVal<2>, Fun<4>>; break;
        case ecVVFFF:  m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, FunFun<2>, Fun<4>>; break;
        case ecVVFVF:  m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, FunVal<2>, Fun<4>>; break;
        case ecVVVFF:  m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, ValFun<2>, Fun<4>>; break;
        case ecVVVVF:  m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, ValVal<2>, Fun<4>>; break;

        case ecVFFFFF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, FunFun<2>, FunFun<4>>; break;
        case ecVFFFVF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, FunFun<2>, ValFun<4>>; break;
        case ecVFFVFF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, FunVal<2>, FunFun<4>>; break;
        case ecVFFVVF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, FunVal<2>, ValFun<4>>; break;
        case ecVFVFFF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, ValFun<2>, FunFun<4>>; break;
        case ecVFVFVF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, ValFun<2>, ValFun<4>>; break;
        case ecVFVVFF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValFun<0>, ValVal<2>, FunFun<4>>; break;
        case ecVVFFFF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, FunFun<2>, FunFun<4>>; break;
        case ecVVFFVF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, FunFun<2>, ValFun<4>>; break;
        case ecVVFVFF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, FunVal<2>, FunFun<4>>; break;
        case ecVVFVVF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, FunVal<2>, ValFun<4>>; break;
        case ecVVVFFF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, ValFun<2>, FunFun<4>>; break;
        case ecVVVFVF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, ValFun<2>, ValFun<4>>; break;
        case ecVVVVFF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, ValVal<2>, FunFun<4>>; break;
        case ecVVVVVF: m_pParseFormula = &ParserBase::ParseCmdCode3<ValVal<0>, ValVal<2>, ValFun<4>>; break;
*/
...
/*
    //---------------------------------------------------------------------------------------------
    template<int TIdx>
    static MUP_INLINE void Val(reginfo &info) 
    {
      const token_type *pTok = &info.rpn[TIdx];
      TValue *pStack = info.stack;
      pStack[++info.idx] = *pTok->Val.ptr * pTok->Val.mul + pTok->Val.fixed;

      if (pTok->Val.ptr2!=nullptr)
        pStack[++info.idx] = *pTok->Val.ptr2 * pTok->Val.mul2 + pTok->Val.fixed2;
    }

    //---------------------------------------------------------------------------------------------
    template<int TIdx>
    static MUP_INLINE void ValVal(reginfo &info) 
    {
      const token_type *pTok = &info.rpn[TIdx];
      TValue *pStack = info.stack;
      pStack[++info.idx] = *pTok->Val.ptr * pTok->Val.mul + pTok->Val.fixed;
    ...
    //---------------------------------------------------------------------------------------------
    template<int TIdx>
    static MUP_INLINE void ValFun(reginfo &info) 
    {
      const token_type *pTok = &info.rpn[TIdx];
      TValue *pStack = info.stack;
      pStack[++info.idx] = *pTok->Val.ptr * pTok->Val.mul + pTok->Val.fixed;
      ...
      // 2. Wert
      ++pTok;
      const token_type::SFunDef &fun = pTok->Fun;
      (*fun.ptr)(&info.stack[info.idx -= fun.argc - 1], fun.argc);
      if (fun.ptr2!=nullptr)
      {
        (*fun.ptr2)(&info.stack[info.idx -= fun.argc2 - 1], fun.argc2);
        
        if (fun.ptr3!=nullptr)
          (*fun.ptr3)(&info.stack[info.idx -= fun.argc3 - 1], fun.argc3);
      }
    }

    //---------------------------------------------------------------------------------------------
    template<int TIdx>
    static MUP_INLINE  void FunFun(reginfo &info) 
    {
      {
        const token_type::SFunDef &fun = info.rpn[TIdx].Fun;
        (*fun.ptr)(&info.stack[info.idx -= fun.argc - 1], fun.argc);
        if (fun.ptr2!=nullptr)
        {
          (*fun.ptr2)(&info.stack[info.idx -= fun.argc2 - 1], fun.argc2);
      ...
      // 2. Funktion
      {
        const token_type::SFunDef &fun = info.rpn[TIdx+1].Fun;
        (*fun.ptr)(&info.stack[info.idx -= fun.argc - 1], fun.argc);
        if (fun.ptr2!=nullptr)
        {
          (*fun.ptr2)(&info.stack[info.idx -= fun.argc2 - 1], fun.argc2);
    ...
    //---------------------------------------------------------------------------------------------
    template<int TIdx>
    static MUP_INLINE  void FunVal(reginfo &info) 
    {
      // 1. Funktion
      const token_type::SFunDef &fun = info.rpn[TIdx].Fun;
      (*fun.ptr)(&info.stack[info.idx -= fun.argc - 1], fun.argc);
      ...
      // 2. Wert
      const token_type *pTok = &info.rpn[TIdx+1];
      TValue *pStack = info.stack;
      pStack[++info.idx] = *pTok->Val.ptr * pTok->Val.mul + pTok->Val.fixed;
    ...
    //---------------------------------------------------------------------------------------------
    template<int TIdx>
    static MUP_INLINE  void Fun(reginfo &info) 
    {
      const token_type::SFunDef &fun = info.rpn[TIdx].Fun;
      (*fun.ptr)(&info.stack[info.idx -= fun.argc - 1], fun.argc);
      if (fun.ptr2!=nullptr)
    ...
    //---------------------------------------------------------------------------------------------
    template<eval_step_fun TStep1>
    TValue ParseCmdCode1() const
    {
      m_info.idx = 0;
      TStep1(m_info);
      return m_pStack[1];
    ...
    //---------------------------------------------------------------------------------------------
    template<eval_step_fun TStep1, eval_step_fun TStep2>
    TValue ParseCmdCode2() const
    {
      m_info.idx = 0;
      TStep1(m_info);
      TStep2(m_info);
    ...
    //---------------------------------------------------------------------------------------------
    template<eval_step_fun TStep1, eval_step_fun TStep2, eval_step_fun TStep3>
    TValue ParseCmdCode3() const
    {
      m_info.idx = 0;
      TStep1(m_info);
      TStep2(m_info);
...
*/
  ...
  #define SXO_VAL(TOK) \
          m_pStack[++sidx] = *(TOK)->Val.ptr * (TOK)->Val.mul + (TOK)->Val.fixed;        \
          if ((TOK)->Val.ptr2!=nullptr)                                                  \
            m_pStack[++sidx] = *(TOK)->Val.ptr2 * (TOK)->Val.mul2 + (TOK)->Val.fixed2;
  ...
  #define SXO_FUN(TOK) \
    ...
    //---------------------------------------------------------------------------------------------
    TValue ParseCmdCode_VFFF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_FUN(&m_pRPN[1])
    ...
    //---------------------------------------------------------------------------------------------
    TValue ParseCmdCode_VFVF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_FUN(&m_pRPN[1])
    ...
    //---------------------------------------------------------------------------------------------
    TValue ParseCmdCode_VVFF() const
    {
      register int sidx = 0;
      SXO_VAL(m_pRPN)
      SXO_VAL(&m_pRPN[1])
